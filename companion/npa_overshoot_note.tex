...
\author{Anton Pakhunov\\ \small Independent researcher\\ \small \texttt{pakhunov.anton.n@gmail.com}\thanks{Exact rational certificates and analysis code accompany
this note.}}
...
\bibitem{proof} A.~P., \emph{No finite level of the NPA hierarchy is exact for the doubly-tilted CHSH functional near the critical tilt}, companion paper (2026).
\end{thebibliography}
